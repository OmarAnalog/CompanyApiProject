...
namespace Service
{
    public class ServiceManager : IServiceManager
    {
        ...
        public ServiceManager(IRepositoryManager repositoryManager, ILoggerManager loggerManager, IMapper mapper, IDataShaper<EmployeeDto> dataShaper,UserManager<User> userManager,IOptions<JwtConfiguration> configuration, IAuthenticationService authenticationService)
        {
